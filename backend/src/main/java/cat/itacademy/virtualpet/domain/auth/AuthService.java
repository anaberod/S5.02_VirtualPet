package cat.itacademy.virtualpet.domain.auth;

import cat.itacademy.virtualpet.api.auth.dto.AuthResponse;
import cat.itacademy.virtualpet.api.auth.dto.LoginRequest;
import cat.itacademy.virtualpet.api.auth.dto.RegisterRequest;
import cat.itacademy.virtualpet.domain.user.User;
import cat.itacademy.virtualpet.domain.user.UserRepository;
import cat.itacademy.virtualpet.security.jwt.JwtService; // <-- Lo crearemos en el Paso 4
